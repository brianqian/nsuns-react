const accessories = {
  ...
  arms: [
    [
      ...
      { title: 'Barbell Row', sets: 4, reps: 10, weight: 45 },
      { title: 'Pullups SS Tricep Pushdown', sets: 4, reps: 10, weight: 0 },
    ...
    [
      ...
      { title: 'Hammer Curls', sets: 4, reps: 10, weight: 45 },
      { title: 'Pullups', sets: 4, reps: 10, weight: 0 },
      { title: 'Lateral Raises', sets: 4, reps: 10, weight: 45 },
    ],
    [
      { title: 'Cable Crunches', sets: 4, reps: 10, weight: 45 },
      { title: 'Dumbell Row', sets: 4, reps: 10, weight: 45 },
      { title: 'Pullups', sets: 4, reps: 10, weight: 0 },
      { title: 'Bicep Curls', sets: 4, reps: 10, weight: 45 },
    ],
    [
      { title: 'Incline DB Curls', sets: 4, reps: 10, weight: 45 },
      { title: 'Facepulls', sets: 4, reps: 10, weight: 45 },
      { title: 'Tricep Extension', sets: 4, reps: 10, weight: 0 },
