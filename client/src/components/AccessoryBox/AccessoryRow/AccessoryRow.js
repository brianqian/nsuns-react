...
class AccessoryRow extends Component {
  ...
  componentDidMount = async () => {
    ...
    if (accessoryPlan === 'custom') {
      console.log(this.props.id, 'custom selected');
    }
  ...
  render() {
    //TODO: Accessory Buttons should only load if loggedIn AND no custom plan exists OR loggedIn AND custom plan selected
    const {
      userAuth,
      title,
      sets,
